...
public class ExamResource {
    ...
    private String validateExam(Map<String, Object> input) {
        if (UtilValidate.isEmpty(input.get("examName"))) return "Exam name is required";
        if (UtilValidate.isEmpty(input.get("noOfQuestions"))) return "Number of questions required";
        if (UtilValidate.isEmpty(input.get("duration"))) return "Duration required";
        if (UtilValidate.isEmpty(input.get("passPercentage"))) return "Pass percentage required";
        return null;
    }

    private String validateTopicId(String topicId) {
        if (UtilValidate.isEmpty(topicId)) return "TopicId is required";
        return null;
    }

    private String validateExamId(String examId) {
        if (UtilValidate.isEmpty(examId)) return "ExamId is required";
        return null;
    }
    ...
    public Response createExam(Map<String, Object> input) {
        ...
        try {
            Map<String, Object> result = getDispatcher().runSync("createExam", input);
    ...
    public Response getTopicById(@PathParam("topicId") String topicId) {
        ...
        try {
            Map<String, Object> result = getDispatcher().runSync("getTopicById",
    ...
    public Response addExamTopics(Map<String, Object> input) {
        ...
        if (UtilValidate.isEmpty(input.get("examId")) || UtilValidate.isEmpty(input.get("topicId"))) {
